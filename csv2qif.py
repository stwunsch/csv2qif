...
with open(output_qif_name, 'w') as output_qif_file:
    ...
    for k in range(len(input_csv_data[0])):
        output_qif_file.write(item%(bank_template_data['account_type'],input_csv_data[0][k],input_csv_data[2][k],input_csv_data[1][k]))
