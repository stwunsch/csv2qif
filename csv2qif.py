...
with codecs.open(input_csv_name, 'r', encoding=bank_template_data['file_encoding']) as input_csv_file:
    ...
    for num, row in enumerate(reader):
        ...
        input_csv_data[2].append(float(row[bank_template_data['row_amount']-1].replace(bank_template_data['thousands_delimiter'],"").replace(bank_template_data['decimal_delimiter'],"."))); # account
